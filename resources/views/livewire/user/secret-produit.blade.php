            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="breadcrumbs-content">
                        <h1 class="page-title">Les details du produit</h1>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-12">
                ...
                {{-- <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-images">
                            <main id="gallery">
                                <div class="main-img">
                                    <img src="{{asset('storage/'.$products->image_1)}}" id="current" alt="image de {{$products->nom_produit}}" width="">
                                </div>
                                <div class="images">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <form method="POST" action="">
                            ...
                            <div class="product-info">
                                <h2 class="title">Aller pour la promo du {{$products->nom_produit}}</h2>
                                <p class="category"><i class="lni lni-tag"></i>{{$products->nom_produit}}<a href="javascript:void(0)">Nom_propriété_article</a></p>
                                <h3 class="price">1 000.000 Frcfa<span class="text-danger">1 500.000 Frcfa</span></h3>
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-4 col-md-4 col-12">
                                            <div class="button cart-button">
                                                <button class="btn" style="width: 100%;">Ajouter panier</button>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-12">
