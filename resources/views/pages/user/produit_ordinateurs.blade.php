                        ...
                        <div class="tab-pane fade show active" id="nav-grid" role="tabpanel" aria-labelledby="nav-grid-tab">
                            <div class="row">
                                @forelse ($products as $product)
                                    @if ($product->id_typeArticle == 5)
                                    <div class="col-lg-4 col-md-6 col-12">
                                        <div class="single-product">
                                            <div class="product-image">
                                                <img src="{{asset('storage/'.$product->image_1)}}" width="100px" height="200px">
                                                <div class="button">
                                                    <a href="{{route('produit_ordis.show', $product->id)}}" class="btn"><i class="lni lni-cart"></i>Ajouter panier</a>
                                                </div>
                                            </div>
                                            <div class="product-info">
                                                <span class="category">{{$product->types->nomTypeArticle}}</span>
                                                <h4 class="title">
                                                    <a href="{{route('produit_ordis.show', $product->id)}}">{{$product->nom_produit}}</a>
                                                </h4>
                                            ...
                                            <div class="col-lg-8 col-md-8 col-12">
                                                <div class="product-info">
                                                    ...
                                                    <div class="price d-flex justify-content-between col-8 ">
                                                        <span class="text-danger"><s>{{$product->prix_reel}}fr cfa</s></span>
                                                        <span class="{{route('produit_ordis.show', $product->id)}}">{{$product->prix_promo}}fr cfa</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
