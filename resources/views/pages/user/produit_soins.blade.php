            ...
            <div class="col-lg-3 col-12">
                ...
                <div class="product-sidebar">
                    ...
                    <div class="single-widget search">
                        ...
                        <form action="#">
                            <input type="text" wire:model.debounce.500='search' placeholder="Rechercher ici...">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        <div class="single-product">
                                            <div class="product-image">
                                                ...
                                                <div class="button">
                                                    <a href="{{route('produit_soins.show', $product->id)}}" class="btn"><i class="lni lni-cart"></i>Ajouter panier</a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-8 col-md-8 col-12">
                                                <div class="product-info">
                                                    ...
                                                    <div class="price d-flex justify-content-between col-8 ">
                                                        <span class="text-danger"><s>{{$product->prix_reel}}fr cfa</s></span>
                                                        <span class="{{route('produit_soins.show', $product->id)}}">{{$product->prix_promo}}fr cfa</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
